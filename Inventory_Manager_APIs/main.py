...
from routers import products, suppliers, locations, inventory, sales, system, users, analytics,integrations,analysis,reports,purchases,loyalty,employee,b2b,khata,invoices,scanner_ws,variants,batches,grn
