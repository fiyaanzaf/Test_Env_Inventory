...
def generate_invoice_pdf(
    ...
    try:
        ...
        # Right side - Total amount box with orange accent
        total_box_width = 200
        total_box_height = 40
        total_box_x = page_width - margin - total_box_width
        total_box_y = summary_y - 30
        
        c.setFillColorRGB(accent_rgb[0]/255, accent_rgb[1]/255, accent_rgb[2]/255)
        c.roundRect(total_box_x, total_box_y, total_box_width, total_box_height, 6, fill=1, stroke=0)
        ...
        c.drawRightString(total_box_x + total_box_width, total_box_y - 8, f"({amount_words})")
