...
/**
 * Full-screen overlay shown when the backend connection is lost.
 * Provides a reconnect button (tries to reach the backend without re-login)
 * and a countdown until full logout.
 */
export const ConnectionLostOverlay: React.FC<Props> = ({ secondsLeft, onReconnect, onLogout }) => {
    ...
    const handleReconnect = async () => {
        ...
        // If ok, the overlay will unmount because status goes back to 'connected'
    };
    ...
    return (
        ...
        >
            <Paper
                elevation={6}
                sx={{
                    maxWidth: 420, width: '90%', p: 4, borderRadius: 4,
            ...
            >
                ...
                <Box sx={{
                    ...
                    <WifiOffIcon sx={{ fontSize: 36, color: '#dc2626' }} />
                </Box>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                    Cannot reach the backend server. Check your network and try reconnecting.
                </Typography>
                ...
                {/* Error message */}
                {lastResult && (
                    <Typography variant="body2" sx={{ mb: 2, color: '#dc2626', fontWeight: 600 }}>
                        {lastResult}
                    </Typography>
                )}
